        ...
        <Container size="lg">
          ...
          >
            {techWithIcons.map((tech, index) => (
              ...
              >
                {/* <div
                  className="animate-gradient-border p-px rounded-lg bg-[linear-gradient(var(--gradient-animation),var(--primary)_10%,var(--secondary)_10%,transparent_10%)]"
                  style={{
                ...
                <div className="p-px border rounded-lg relative overflow-hidden">
                  <div
